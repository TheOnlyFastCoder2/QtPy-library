...
2. #### Поддержка типизированных строковых ключей
   ...
   - поддерживать доступ к кортежам и массивам по индексам, например: "items.0" или "list.2.name". 3. #### Подписки с «гранулярностью» путей

   <img src="./assets/picture_autocomplete.png" width="1200"/>
